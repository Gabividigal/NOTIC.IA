...
export default function UpgradeProModal({ aberto, onFechar }: UpgradeProModalProps) {
  ...
  return (
    <Modal aberto={aberto} onFechar={onFechar} titulo="NOTIC.IA PRO" largura="max-w-lg">
